...
<section class="breadcrumbs">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Comunicação à CGA,IP</h2>
            <ol>
                <li>INICIO</li>
                <li>Comunicação à CGA,IP</li>
            </ol>
        </div>
    </div>
</section>
...
<section id="contact" class="contact">
    <form  role="form" class="php-email-form2">
        <div class="container">
            <p>
                <b><h2> Comunicação à CGA,IP</h2></b> 
            </p>
            <div class="mec-single-event-description mec-events-content">
                <p>Comunicação à CGA,IP dos montantes pagos nesse mês referentes a pensões (Cat.H), independentemente dos valores atingirem ou não, o valor de incidência da CES.</p>
