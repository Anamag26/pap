...
<section class="breadcrumbs">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2>INÍCIO ENTREGA DA MODELO 3 DO IRS</h2>
            <ol>
                <li>INICIO</li>
                <li>INÍCIO ENTREGA DA MODELO 3 DO IRS</li>
            </ol>
        </div>
    </div>
</section>
...
<section id="contact" class="contact">
    <form  role="form" class="php-email-form2">
        <div class="container">
            <p>
                <b><h2> INÍCIO ENTREGA DA MODELO 3 DO IRS</h2></b> 
            </p>
            <div class="mec-single-event-description mec-events-content">
                <p>Início no dia 1 de abril, da entrega da Modelo 3 do IRS- Declaração de Rendimentos de 2020 para todos os contribuintes, independentemente do tipo de rendimentos.</p>
