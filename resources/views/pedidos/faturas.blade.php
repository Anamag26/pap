...
<section class="breadcrumbs">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Comunicação dos elementos das faturas</h2>
            <ol>
                <li>INICIO</li>
                <li>Comunicação dos elementos das faturas</li>
            </ol>
        </div>
    </div>
</section>
...
<section id="contact" class="contact">
    <form  role="form" class="php-email-form2">
        <div class="container">
            <p>
                <b><h2> Comunicação dos elementos das faturas</h2></b> 
            </p>
            <div class="mec-single-event-description mec-events-content">
                <p>As pessoas, singulares ou coletivas, que tenham sede, estabelecimento estável ou domicílio fiscal em território português e aqui pratiquem operações sujeitas a IVA, são obrigadas a comunicar à AT, por transmissão eletrónica de dados, os elementos das faturas emitidas no mês anterior, bem como os elementos dos documentos de conferência de entrega de mercadorias ou da prestação de serviços, assim como os elementos dos recibos emitidos no regime do IVA de caixa.</p>
            </div>
