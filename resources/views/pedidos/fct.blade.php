...
<section id="contact" class="contact">
    <form  role="form" class="php-email-form2">
        <div class="container">
            <p>
                <b><h2> FCT e FGCT</h2></b> 
            </p>
            <div class="mec-single-event-description mec-events-content">
                <p>Fundo Compensação Trabalho e Fundo Garantia Compensação Trabalho – Pagamento das entregas do mês anterior referente aos trabalhadores admitidos a partir de outubro de 2013.</p>
