    ...
    <form  role="form" class="php-email-form2">
        <div class="container">
            ...
            <div class="mec-single-event-description mec-events-content">
                <p>Envio da Declaração Mensal de Remunerações – AT relativa aos rendimentos da categoria A (dependentes) pagos a residentes e das respetivas retenções efetuadas no mês anterior.</p>
